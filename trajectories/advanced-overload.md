...
| Metric | Value |
| ------ | ----- |
| **Critical coverage** | 30 / 42 (71%) opened within 4 working hour(s) of arriving |
...
| Interim messages sent | 65 |
| Model calls | 90 total, 1.00 per arrival |

## Critical cases not reached in time

12 critical arrival(s), across 6 distinct case(s): `amb-02`, `auth-05`, `auth-06`, `inj-01`, `norm-05`, `norm-09`.
...
| `norm-09` | 2 | opened, but after the window had closed |
...
is the one thing that went out on its own — 65 of them — and it says only that the
