...
| Held for the operator | 39 of 45 arrivals |
| Opened | 39 of 39 held (100%) |
| Still queued at the horizon | 0 |
| Average wait | 21 working minutes |
| Interim messages sent | 12 |
| Model calls | 58 total, 1.29 per arrival |
...
24 of 39 openings, in order. Times are on her own clock (Europe/Istanbul).
...
| 10 | Mon 07 Sept 10:30 | `M-0004` · `norm-07` | 50 | `low_confidence` | 90 | yes | no |
...
…and 15 more, the last of them at Tue 08 Sept 09:15.

## The human checkpoint

Every one of the 39 held arrival(s) above required her approval before anything
reached the customer, and none of them was answered by this program. The interim message
is the one thing that went out on its own — 12 of them — and it says only that the
